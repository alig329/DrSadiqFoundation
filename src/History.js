...
const History = () => {
  return (
    <Box sx={{ backgroundColor: '#FFFFFF', padding: '20px', width: '100%', marginTop: '40px' }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'stretch', marginBottom: '40px' }}>
        ...
        <Typography variant="h2" sx={{ fontFamily: 'Poppins', fontSize: { xs: '20px', sm: '30px', md: '40px' }, fontWeight: 'bold', lineHeight: '40px', color: '#000000' }}>
      ...
      <Box sx={{ backgroundColor: '#027D40', padding: '40px', alignItems: 'stretch', marginBottom: '80px' }}>
        ...
        <Box sx={{ flex: 1, mb: { xs: '20px', md: 0 }, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <Typography variant="h2" sx={{ fontFamily: 'Poppins', fontSize: { xs: '20px', sm: '30px', md: '40px' }, fontWeight: '500', lineHeight: '80px', color: '#FFFFFF' }}>
          Pioneering a Poultry Empire
          </Typography>
          <Typography sx={{ fontFamily: 'Poppins', fontSize: { xs: '14px', sm: '16px', md: '18px' }, fontWeight: '500', lineHeight: { xs: '30px', md: '54px' }, color: '#FFFFFF', textAlign: 'left' }}>
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'stretch' }}>
          <img src='/hist1.png' alt="Dr. Muhammad Sadiq" style={{ width: '90%', height: '100%', objectFit: 'cover' }} />
        </Box>
      </Box>
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'stretch' }}>
          <img src='/hist2.png' alt="Dr. Muhammad Sadiq" style={{ width: '90%', height: '100%', objectFit: 'cover' }} />
        </Box>
      </Box>
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'stretch' }}>
          <img src='/hist3.png' alt="Dr. Muhammad Sadiq" style={{ width: '90%', height: '100%', objectFit: 'cover' }} />
        </Box>
      </Box>
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'stretch' }}>
          <img src='/hist4.png' alt="Dr. Muhammad Sadiq" style={{ width: '90%', height: '100%', objectFit: 'cover' }} />
        </Box>
      </Box>
      </Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', flexDirection: { xs: 'column', md: 'column' }, alignItems: 'stretch', marginBottom: '40px' }}>
        ...
        <Box sx={{ flex: 1, mb: { xs: '20px', md: 0 }, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <Typography variant="h2" sx={{ display: 'flex', justifyContent: 'center', fontSize: { xs: '20px', sm: '30px', md: '40px' }, fontWeight: '500', lineHeight: '60px', color: '#000000' }}>
